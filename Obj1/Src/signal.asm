	...
	export TabSig
; cos, frequence relative 1  phase zero  amplitude max
; valeurs attendues pour k = 1 : Re	0x7FFFD135	env +2^31 /  Im	0xFFFFF800	env 0   / M2	0x3FFFD135	env 2^30
; pour k > 1	M2    < 0x0000000F

TabSig
	dcw	0x0fff	;  0   0000  0.00000
